...
export default function Page() {
  ...
  //         <Badge variant="outline">Primary screen</Badge>
  //       </div>
  //     </header>
  ...
  //               <Image
  //                 src="/docs/game-selection/game-selection.png"
  ...
  //               >
  //                 <Image
  //                   src="/docs/game-selection/how-to-play.png"
  ...
  //           <CardContent>
  //             <div className="relative aspect-[16/9] w-full overflow-hidden rounded-md border bg-[linear-gradient(90deg,rgba(0,0,0,0.04)_1px,transparent_1px),linear-gradient(rgba(0,0,0,0.04)_1px,transparent_1px)] bg-[size:20px_20px]">
  //               <Image src="/docs/game-selection/game-selection.png" alt="Admin corner pattern" fill className="object-cover opacity-90" />
  ...
  //                 <Image src="/docs/game-selection/admin-password.png" alt="Admin dialog" fill className="object-contain bg-muted" />
  //               </div>
  //               <p className="mb-4 text-sm text-muted-foreground">
  ...
  //     <strong>Display order by number of screens:</strong> with <em>one</em> screen you show <em>Game Selection</em> only. If you have an extra screen, it shows the <em>Scorecard</em>; with a third screen, add the <em>Room Identifier</em>.
  //   </p>
  ...
  //     <H3>Scorecards</H3>
  //     <p className="text-sm text-muted-foreground">
  //       Three types are supported. <strong>Competitive</strong> and <strong>Alliance</strong> include an image placeholder and a label. <strong>Custom</strong> (currently for <em>Recipe</em>) includes an image placeholder only.
  //     </p>
  ...
  //           </div>
  //           <CardTitle className="text-base">Scorecard — Competitive</CardTitle>
  //           <CardDescription>Players, their scores, lifeline/s, time remaining, and level.</CardDescription>
  //         </CardHeader>
  //         <CardContent>
  ...
  //           </div>
  //           <CardTitle className="text-base">Scorecard — Alliance</CardTitle>
  //           <CardDescription>Single team score, lifelines, time remaining, and level.</CardDescription>
  //         </CardHeader>
  //         <CardContent>
  //           <div className="relative aspect-video w-full overflow-hidden rounded-md border bg-muted">
  //             <Image
  ...
  //           <CardDescription>Used when players need extra information onscreen.</CardDescription>
  //         </CardHeader>
  //         <CardContent>
  //           <div className="relative aspect-video w-full overflow-hidden rounded-md border bg-muted">
  //             <Image
  ...
  //     <Card>
  //       <CardHeader className="pb-2">
  //         <CardTitle className="text-base">Identifiers for Each Rooms</CardTitle>
  //       </CardHeader>
  //       <CardContent>
  //         <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
  //           {gameroomData.map((gameRoom, i) => (
  //             <div key={i} className="relative aspect-video w-full overflow-hidden rounded-md border bg-muted">
  //               <Image
  //                 src={gameRoom.image}
  ...
  //                 className="object-contain"
  //               />
  //               <span className="absolute left-2 bottom-2 rounded bg-background/80 px-2 py-0.5 text-xs">{gameRoom.name} Identifier</span>
  //             </div>
  //           ))}
  //         </div>
  //       </CardContent>
